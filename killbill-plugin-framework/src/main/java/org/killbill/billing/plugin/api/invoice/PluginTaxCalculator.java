...
public abstract class PluginTaxCalculator {
    ...
    public PluginTaxCalculator(final KillbillApi killbillApi) {
    ...
    public List<NewItemToTax> computeTaxItems(final Invoice invoice,
        ...
        for (final UUID invoiceItemId : adjustmentsByLinkedId.keySet()) {
            ...
            final Invoice previousInvoice = killbillApi.getInvoiceUserApi().getInvoiceByInvoiceItem(invoiceItemId, tenantContext);
