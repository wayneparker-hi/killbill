...
import org.killbill.billing.plugin.runtime.PlatformServiceUnavailableException;
...
public abstract class PluginApi {
    ...
    protected final PluginConfigProperties configProperties;
    protected final Clock clock;

    protected PluginApi(final KillbillApi killbillApi, final PluginConfigProperties configProperties, final Clock clock) {
    ...
    protected Long getTenantRecordId(final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected Account getAccount(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
        ...
        try {
            ...
            throw new PlatformServiceUnavailableException(e);
        }
    }

    protected AccountAuditLogs getAccountAuditLogs(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected AuditLog getAccountCreationAuditLog(final UUID accountId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getAccountRecordId(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected List<SubscriptionBundle> getSubscriptionBundlesForAccount(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected SubscriptionBundle getLatestSubscriptionBundleForExternalKey(final String bundleExternalKey, final TenantContext context) throws PlatformServiceUnavailableException {
        final SubscriptionApi subscriptionApi = getSubscriptionApi();

        try {
            final List<SubscriptionBundle> bundles = subscriptionApi.getSubscriptionBundlesForExternalKey(bundleExternalKey, context);
            if (bundles.isEmpty()) {
                throw new PlatformServiceUnavailableException("Unable to retrieve latest bundle for bundle external key " + bundleExternalKey);
            }
    ...
    protected Long getBundleRecordId(final UUID bundleId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
        return recordIdUserApi.getRecordId(bundleId, ObjectType.BUNDLE, context);
    }

    protected AuditLog getBundleCreationAuditLog(final UUID bundleId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected AuditLog getSubscriptionEventCreationAuditLog(final UUID subscriptionEventId, final ObjectType objectType, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getSubscriptionEventRecordId(final UUID subscriptionEventId, final ObjectType objectType, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected Iterable<SubscriptionEvent> getBlockingHistory(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected AuditLog getBlockingStateCreationAuditLog(final UUID blockingStateId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getBlockingStateRecordId(final UUID blockingStateId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected AuditLog getInvoiceCreationAuditLog(final UUID invoiceId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getInvoiceRecordId(final UUID invoiceId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
        return recordIdUserApi.getRecordId(invoiceId, ObjectType.INVOICE, context);
    }

    protected AuditLog getInvoiceItemCreationAuditLog(final UUID invoiceItemId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getInvoiceItemRecordId(final UUID invoiceItemId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
        return recordIdUserApi.getRecordId(invoiceItemId, ObjectType.INVOICE_ITEM, context);
    }

    protected Collection<Invoice> getInvoicesByAccountId(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected BigDecimal getAccountBalance(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
        final InvoiceUserApi invoiceUserApi = getInvoiceUserApi();
        return invoiceUserApi.getAccountBalance(accountId, context);
    }

    protected Plan getPlanFromInvoiceItem(final InvoiceItem invoiceItem, final TenantContext context) throws PlatformServiceUnavailableException {
        try {
    ...
    protected PlanPhase getPlanPhaseFromInvoiceItem(final InvoiceItem invoiceItem, final LocalDate subscriptionStartDate, final TenantContext context) throws PlatformServiceUnavailableException {
        try {
            final VersionedCatalog catalog = getCatalog(context);
            // getCatalogEffectiveDate was introduced in 0.21.x
            final DateTime catalogEffectiveDate = Objects.requireNonNullElse(invoiceItem.getCatalogEffectiveDate(), invoiceItem.getCreatedDate());
    ...
    protected VersionedCatalog getCatalog(final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected Map<UUID, List<InvoicePayment>> getAccountInvoicePayments(final Iterable<Payment> payments, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected AuditLog getInvoicePaymentCreationAuditLog(final UUID invoicePaymentId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getInvoicePaymentRecordId(final UUID invoicePaymentId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected Collection<Payment> getPaymentsWithPluginInfoByAccountId(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected List<PaymentMethod> getPaymentMethodsForAccount(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
        final PaymentApi paymentApi = getPaymentUserApi();
    ...
    protected PaymentMethod getPaymentMethod(final UUID paymentMethodId, final TenantContext context) throws PlatformServiceUnavailableException {
        final PaymentApi paymentApi = getPaymentUserApi();
    ...
    protected AuditLog getPaymentCreationAuditLog(final UUID paymentId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected PaymentTransaction getPaymentTransaction(final UUID kbPaymentId, final UUID kbTransactionId, final TenantContext context) throws PlatformServiceUnavailableException {
    ...
    protected PaymentTransaction getPaymentTransaction(final UUID kbTransactionId, final Payment payment) throws PlatformServiceUnavailableException {
        return payment.getTransactions().stream()
                      .filter(input -> input != null && kbTransactionId.equals(input.getId()))
                      .findFirst().get();
    }

    protected Long getPaymentRecordId(final UUID paymentId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected Collection<CustomField> getFieldsForAccount(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
        final CustomFieldUserApi tagUserApi = getCustomFieldUserApi();
        return tagUserApi.getCustomFieldsForAccount(accountId, context);
    }

    protected AuditLog getFieldCreationAuditLog(final UUID fieldId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getFieldRecordId(final UUID fieldId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected Collection<Tag> getTagsForAccount(final UUID accountId, final TenantContext context) throws PlatformServiceUnavailableException {
        final TagUserApi tagUserApi = getTagUserApi();
        return tagUserApi.getTagsForAccount(accountId, false, context);
    }

    protected List<TagDefinition> getTagDefinitions(final TenantContext context) throws PlatformServiceUnavailableException {
        final TagUserApi tagUserApi = getTagUserApi();
        return tagUserApi.getTagDefinitions(context);
    }

    protected AuditLog getTagCreationAuditLog(final UUID tagId, final AccountAuditLogs accountAuditLogs) throws PlatformServiceUnavailableException {
    ...
    protected Long getTagRecordId(final UUID tagId, final TenantContext context) throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdUserApi = getRecordIdUserApi();
    ...
    protected AccountUserApi getAccountUserApi() throws PlatformServiceUnavailableException {
        final AccountUserApi accountUserApi = killbillApi.getAccountUserApi();
        if (accountUserApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving accountUserApi");
        }
        return accountUserApi;
    }

    protected SubscriptionApi getSubscriptionApi() throws PlatformServiceUnavailableException {
        final SubscriptionApi subscriptionApi = killbillApi.getSubscriptionApi();
        if (subscriptionApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving subscriptionApi");
        }
        return subscriptionApi;
    }

    protected InvoiceUserApi getInvoiceUserApi() throws PlatformServiceUnavailableException {
        final InvoiceUserApi invoiceUserApi = killbillApi.getInvoiceUserApi();
        if (invoiceUserApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving invoiceUserApi");
        }
        return invoiceUserApi;
    }

    protected CatalogUserApi getCatalogUserApi() throws PlatformServiceUnavailableException {
        final CatalogUserApi catalogUserApi = killbillApi.getCatalogUserApi();
        if (catalogUserApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving catalogUserApi");
        }
        return catalogUserApi;
    }

    protected PaymentApi getPaymentUserApi() throws PlatformServiceUnavailableException {
        final PaymentApi paymentApi = killbillApi.getPaymentApi();
        if (paymentApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving paymentApi");
        }
        return paymentApi;
    }

    protected InvoicePaymentApi getInvoicePaymentUserApi() throws PlatformServiceUnavailableException {
        final InvoicePaymentApi invoicePaymentApi = killbillApi.getInvoicePaymentApi();
        if (invoicePaymentApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving invoicePaymentApi");
        }
        return invoicePaymentApi;
    }

    protected CustomFieldUserApi getCustomFieldUserApi() throws PlatformServiceUnavailableException {
        final CustomFieldUserApi fieldUserApi = killbillApi.getCustomFieldUserApi();
        if (fieldUserApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving fieldUserApi");
        }
        return fieldUserApi;
    }

    protected TagUserApi getTagUserApi() throws PlatformServiceUnavailableException {
        final TagUserApi tagUserApi = killbillApi.getTagUserApi();
        if (tagUserApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving tagUserApi");
        }
        return tagUserApi;
    }

    protected RecordIdApi getRecordIdUserApi() throws PlatformServiceUnavailableException {
        final RecordIdApi recordIdApi = killbillApi.getRecordIdApi();
        if (recordIdApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving recordIdApi");
        }
        return recordIdApi;
    }

    protected AuditUserApi getAuditUserApi() throws PlatformServiceUnavailableException {
        final AuditUserApi auditUserApi = killbillApi.getAuditUserApi();
        if (auditUserApi == null) {
            throw new PlatformServiceUnavailableException("Error retrieving auditUserApi");
        }
        return auditUserApi;
    }
}
