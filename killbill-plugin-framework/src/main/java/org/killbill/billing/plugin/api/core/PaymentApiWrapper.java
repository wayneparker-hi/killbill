...
public class PaymentApiWrapper {
    ...
    private final KillbillApi killbillApi;
    private final boolean withControl;

    public PaymentApiWrapper(final KillbillApi killbillApiL, final boolean withControl) {
        this.killbillApi = killbillApiL;
    ...
    public List<String> getPaymentControlPluginNames(final UUID kbPaymentId, final TenantContext context) throws PaymentApiException {
        ...
        final Payment payment = killbillApi.getPaymentApi().getPayment(kbPaymentId, false, true, Collections.emptyList(), context);
    ...
    public PaymentTransaction transitionPendingTransaction(final Account account,
        ...
        if (paymentOptions == null) {
            payment = killbillApi.getPaymentApi().notifyPendingTransactionOfStateChanged(account,
                                                                                             kbPaymentTransactionId,
                                                                                             paymentPluginStatus == PaymentPluginStatus.PROCESSED,
                                                                                             context);
        } else {
            payment = killbillApi.getPaymentApi().notifyPendingTransactionOfStateChangedWithPaymentControl(account,
                                                                                                               kbPaymentTransactionId,
                                                                                                               paymentPluginStatus == PaymentPluginStatus.PROCESSED,
                                                                                                               paymentOptions,
                                                                                                               context);
    ...
    public PaymentTransaction fixPaymentTransactionState(final Payment payment,
        ...
        killbillApi.getAdminPaymentApi().fixPaymentTransactionState(payment, updatedPaymentTransaction, transactionStatus, lastSuccessfulPaymentStateName, currentPaymentStateName, Collections.emptyList(), context);
        final Payment fixedPayment = killbillApi.getPaymentApi().getPayment(payment.getId(), true, false, Collections.emptyList(), context);
    ...
    public PaymentTransaction createPayment(final TransactionType transactionType,
        ...
        switch (transactionType) {
            case AUTHORIZE:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createAuthorization(account,
                                                                                         kbPaymentMethodId,
                                                                                         kbPaymentId,
                                                                                         amount,
                                                                                         currency,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createAuthorizationWithPaymentControl(account,
                                                                                                           kbPaymentMethodId,
                                                                                                           kbPaymentId,
                                                                                                           amount,
                                                                                                           currency,
            ...
            case CAPTURE:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createCapture(account,
                                                                                   kbPaymentId,
                                                                                   amount,
                                                                                   currency,
                                                                                   effectiveDate,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createCaptureWithPaymentControl(account,
                                                                                                     kbPaymentId,
                                                                                                     amount,
                                                                                                     currency,
                                                                                                     effectiveDate,
            ...
            case CHARGEBACK:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createChargeback(account,
                                                                                      kbPaymentId,
                                                                                      amount,
                                                                                      currency,
                                                                                      effectiveDate,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createChargebackWithPaymentControl(account,
                                                                                                        kbPaymentId,
                                                                                                        amount,
                                                                                                        currency,
                                                                                                        effectiveDate,
            ...
            case CREDIT:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createCredit(account,
                                                                                  kbPaymentMethodId,
                                                                                  kbPaymentId,
                                                                                  amount,
                                                                                  currency,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createCreditWithPaymentControl(account,
                                                                                                    kbPaymentMethodId,
                                                                                                    kbPaymentId,
                                                                                                    amount,
                                                                                                    currency,
            ...
            case PURCHASE:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createPurchase(account,
                                                                                    kbPaymentMethodId,
                                                                                    kbPaymentId,
                                                                                    amount,
                                                                                    currency,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createPurchaseWithPaymentControl(account,
                                                                                                      kbPaymentMethodId,
                                                                                                      kbPaymentId,
                                                                                                      amount,
                                                                                                      currency,
            ...
            case REFUND:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createRefund(account,
                                                                                  kbPaymentId,
                                                                                  amount,
                                                                                  currency,
                                                                                  effectiveDate,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createRefundWithPaymentControl(account,
                                                                                                    kbPaymentId,
                                                                                                    amount,
                                                                                                    currency,
                                                                                                    effectiveDate,
            ...
            case VOID:
                if (paymentOptions == null) {
                    createdPayment = killbillApi.getPaymentApi().createVoid(account,
                                                                                kbPaymentId,
                                                                                effectiveDate,
                                                                                paymentTransactionExternalKey,
                                                                                pluginProperties,
                    ...
                    createdPayment = killbillApi.getPaymentApi().createVoidWithPaymentControl(account,
                                                                                                  kbPaymentId,
                                                                                                  effectiveDate,
                                                                                                  paymentTransactionExternalKey,
                                                                                                  pluginProperties,
    ...
    public PaymentTransaction createChargeback(final Account account,
        ...
        final PaymentOptions paymentOptions = getPaymentOptions(kbPaymentId, context);
        if (paymentOptions == null) {
            chargeback = killbillApi.getPaymentApi().createChargeback(account,
                                                                          kbPaymentId,
                                                                          amount,
                                                                          currency,
                                                                          effectiveDate,
            ...
            chargeback = killbillApi.getPaymentApi().createChargebackWithPaymentControl(account,
                                                                                            kbPaymentId,
                                                                                            amount,
                                                                                            currency,
                                                                                            effectiveDate,
    ...
    public PaymentTransaction createChargebackReversal(final Account account,
        ...
        final PaymentOptions paymentOptions = getPaymentOptions(kbPaymentId, context);
        if (paymentOptions == null) {
            chargebackReversal = killbillApi.getPaymentApi().createChargebackReversal(account,
                                                                                          kbPaymentId,
                                                                                          effectiveDate,
                                                                                          paymentTransactionExternalKey,
                                                                                          context);
        } else {
            chargebackReversal = killbillApi.getPaymentApi().createChargebackReversalWithPaymentControl(account,
                                                                                                            kbPaymentId,
                                                                                                            effectiveDate,
                                                                                                            paymentTransactionExternalKey,
                                                                                                            paymentOptions,
