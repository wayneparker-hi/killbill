...
public abstract class TestUtils {
    ...
    public static KillbillApi buildKillbillApi(final Account account) throws AccountApiException, PaymentApiException {
        final KillbillApi killbillApi = Mockito.mock(KillbillApi.class);
    ...
    public static void updateKillbillApi(final KillbillApi killbillApi, final PaymentPluginApi paymentPluginApi) throws PaymentApiException {
    ...
    public static Payment buildPayment(final UUID accountId, final UUID paymentMethodId, final Currency currency, @Nullable final KillbillApi killbillApi) throws PaymentApiException {
        return buildPayment(accountId, paymentMethodId, UUID.randomUUID(), currency, UUID.randomUUID().toString(), killbillApi);
    }

    public static Payment buildPayment(final UUID accountId, final UUID paymentMethodId, final UUID paymentId, final Currency currency, final String paymentExternalKey, @Nullable final KillbillApi killbillApi) throws PaymentApiException {
    ...
    public static PaymentMethod buildPaymentMethod(final UUID accountId, final UUID paymentMethodId, final String pluginName, @Nullable final KillbillApi killbillApi) throws PaymentApiException {
