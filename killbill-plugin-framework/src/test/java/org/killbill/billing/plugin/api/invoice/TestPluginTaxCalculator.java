...
public class TestPluginTaxCalculator {
    ...
    private static final class PluginTaxCalculatorTest extends PluginTaxCalculator {
        ...
        public PluginTaxCalculatorTest(final KillbillApi killbillApi) {
            super(killbillApi);
        }
    }
    ...
    public void setUp() throws Exception {
        ...
        final KillbillApi killbillApi = TestUtils.buildKillbillApi(account);
        Mockito.when(killbillApi.getInvoiceUserApi()).thenReturn(Mockito.mock(InvoiceUserApi.class));
        pluginTaxCalculatorTest = new PluginTaxCalculatorTest(killbillApi);
        ...
        Mockito.when(killbillApi.getInvoiceUserApi().getInvoiceByInvoiceItem(Mockito.eq(invoice1TaxableItem.getId()), Mockito.<TenantContext>any()))
               .thenReturn(invoice1);
