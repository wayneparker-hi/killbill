...
public class TestPluginApi {
    ...
    private PluginConfigProperties configProperties;
    private Clock clock;
    ...
    public void beforeMethod() {
        ...
        configProperties = Mockito.mock(PluginConfigProperties.class);
        clock = Mockito.mock(Clock.class);

        final PluginApi toSpy = new PluginApi(killbillApi, configProperties, clock) {};
