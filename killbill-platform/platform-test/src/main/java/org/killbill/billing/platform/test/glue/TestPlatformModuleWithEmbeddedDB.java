...
public class TestPlatformModuleWithEmbeddedDB extends TestPlatformModule {
    ...
    public TestPlatformModuleWithEmbeddedDB(final KillbillConfigSource configSource, final boolean withPluginRuntime, @Nullable final KillbillConfigProperties pluginConfigProperties) {
        super(configSource, withPluginRuntime, pluginConfigProperties, null);
