...
public abstract class TestPlatformModule extends KillBillPlatformModuleBase {
    ...
    private final boolean withPluginRuntime;
    private final KillbillConfigProperties pluginConfigProperties;
    private final Set<? extends KillbillService> services;

    protected TestPlatformModule(final KillbillConfigSource configSource, final boolean withPluginRuntime, @Nullable final KillbillConfigProperties pluginConfigProperties, @Nullable final Set<? extends KillbillService> services) {
        super(configSource);
        this.withPluginRuntime = withPluginRuntime;
