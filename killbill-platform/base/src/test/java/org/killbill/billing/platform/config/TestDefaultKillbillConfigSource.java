...
import org.killbill.billing.platform.api.KillbillConfigProperties;
...
public class TestDefaultKillbillConfigSource {
    ...
    public void testGetPropertiesBySourceContainsExpectedSources() throws URISyntaxException, IOException {
        ...
        final KillbillConfigProperties configSource = new DefaultKillbillConfigSource(null, runtimeConfig) {
            @Override
    ...
    public void testGetPropertiesAndGetPropertiesBySourceAreInSync() throws URISyntaxException, IOException {
        ...
        killbillDefaultConfig.put("org.killbill.billing.plugin.dao.logLevel", "INFO");

        // ImmutableSystemProperties
        killbillDefaultConfig.put("user.timezone", "GMT");

        // EnvironmentVariables
        final KillbillConfigProperties configSource = new DefaultKillbillConfigSource(null, killbillDefaultConfig) {
            @Override
            protected Map<String, String> getEnvironmentVariables() {
                final Map<String, String> mockEnv = new HashMap<>();
    ...
    public void testGetProperties() throws URISyntaxException, IOException {
        ...
        final KillbillConfigProperties configSource = new DefaultKillbillConfigSource(null, configuration);
    ...
    public void testGetPropertiesBySource() throws URISyntaxException, IOException {
        ...
        final KillbillConfigProperties configSource = new DefaultKillbillConfigSource(null, killbillDefaultConfig) {
            ...
            protected Map<String, String> getEnvironmentVariables() {
                final Map<String, String> mockEnv = new HashMap<>();
                mockEnv.put(ENVIRONMENT_VARIABLE_PREFIX + "org_killbill_dao_healthCheckConnectionTimeout", "11s");
                mockEnv.put(ENVIRONMENT_VARIABLE_PREFIX + "org_killbill_billing_plugin_dao_maxActive", "99");
        ...
        Assert.assertEquals(environmentVariables.get("org.killbill.billing.plugin.dao.maxActive"), "99");
        ...
        Assert.assertEquals(killBillDefaults.get("org.killbill.billing.plugin.dao.logLevel"), "INFO");
    ...
    public void testFromEnvVariableName() throws IOException, URISyntaxException {
        ...
        Assert.assertEquals(configSource.fromEnvVariableName(ENVIRONMENT_VARIABLE_PREFIX + "org_killbill_billing_plugin_dao_prepStmtCacheSize"), "org.killbill.billing.plugin.dao.prepStmtCacheSize");
        // Note! This won't work: we don't support underscores in property keys
        //Assert.assertEquals(configSource.fromEnvVariableName("org_killbill_billing_plugin_dao_prepStmtCacheSize"), "org.killbill.billing.plugin.dao_prepStmtCacheSize");
        Assert.assertEquals(configSource.fromEnvVariableName(ENVIRONMENT_VARIABLE_PREFIX + "org_killbill_billing_plugin_dao__prepStmtCacheSize"), "org.killbill.billing.plugin.dao..prepStmtCacheSize");
    }
