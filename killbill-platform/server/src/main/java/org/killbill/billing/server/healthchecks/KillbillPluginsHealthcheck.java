...
import org.killbill.billing.runtime.api.Healthcheck.HealthStatus;
...
public class KillbillPluginsHealthcheck implements HealthCheck {
    ...
    private PluginServiceRegistry<Healthcheck> pluginHealthchecks = null;

    @Inject
    public void setPluginHealthchecks(@Nullable final PluginServiceRegistry<Healthcheck> pluginHealthchecks) {
