...
public class KillbillHealthcheck implements HealthCheck {
    ...
    private PluginServiceRegistry<ServiceDiscoveryRegistry> pluginServiceDiscoveryRegistries = null;
    ...
    @Inject
    public void setPluginServiceDiscoveryRegistries(@Nullable final PluginServiceRegistry<ServiceDiscoveryRegistry> pluginServiceDiscoveryRegistries) {
