...
/**
 * How plugins read configuration.
 * <p>
 * Plugins must go through this rather than {@code System.getProperties()}. Under OSGi that was a
 * technical necessity, because a bundle's view of the system properties was not guaranteed. It
 * remains the rule for a better reason: configuration reached behind the runtime's back cannot be
 * overridden per tenant, cannot be reloaded, and does not appear when inspecting a plugin's
 * effective configuration.
 */
public interface KillbillConfigProperties {
