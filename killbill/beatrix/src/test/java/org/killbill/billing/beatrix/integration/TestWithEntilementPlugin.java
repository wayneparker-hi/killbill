...
public class TestWithEntilementPlugin extends TestIntegrationBase {
    ...
    @Inject
    private PluginServiceRegistry<EntitlementPluginApi> pluginRegistry;
    ...
    public void beforeClass() throws Exception {
        ...
        pluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn("TestEntitlementPluginApi"), testEntitlementPluginApi);
    }
