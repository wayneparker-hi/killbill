...
public class TestIntegrationParentInvoice extends TestIntegrationBase {
    ...
    public void testParentInvoiceGeneration() throws Exception {
        ...
        final Account parentAccount = createAccountWithBuiltInPaymentMethod(getAccountData(billingDay));
        final Account child1Account = createAccountWithBuiltInPaymentMethod(getChildAccountData(billingDay, parentAccount.getId(), true));
        final Account child2Account = createAccountWithBuiltInPaymentMethod(getChildAccountData(billingDay, parentAccount.getId(), true));
    ...
    public void testParentInvoiceGenerationMultipleActionsSameDay() throws Exception {
        ...
        final Account parentAccount = createAccountWithBuiltInPaymentMethod(getAccountData(billingDay));
        final Account childAccount = createAccountWithBuiltInPaymentMethod(getChildAccountData(billingDay, parentAccount.getId(), true));
    ...
    public void testParentInvoiceTransferCreditAccountNoParent() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getChildAccountData(billingDay, null, true));
    ...
    public void testUnParentingWithUnpaidInvoice() throws Exception {
        ...
        final Account parentAccount = createAccountWithBuiltInPaymentMethod(getAccountData(billingDay));
        Account childAccount = createAccountWithBuiltInPaymentMethod(getChildAccountData(billingDay, parentAccount.getId(), true));
    ...
    public void testParentingWithFuturePhaseEvent() throws Exception {
        ...
        final Account parentAccount = createAccountWithBuiltInPaymentMethod(getAccountData(billingDay));
        Account childAccount = createAccountWithBuiltInPaymentMethod(getAccountData(billingDay));
