...
import org.killbill.billing.platform.plugin.api.ReadOnlyTenantContext;
...
public class TestDBRouter extends TestIntegrationBase {
    ...
    public class PublicListener {
        ...
        public void handleExternalEvents(final ExtBusEvent event) {
            ...
            final ReadOnlyTenantContext roTenantContext = new ReadOnlyTenantContext(tenantContext);
