...
public class TestIntegration extends TestIntegrationBase { //TODO_1739 - This test has major changes and needs to be reviewed carefully
    ...
    public void testAddonsWithMultipleAlignments() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(25));
    ...
    public void testForMultipleRecurringPhases() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(2));
        final UUID accountId = account.getId();
