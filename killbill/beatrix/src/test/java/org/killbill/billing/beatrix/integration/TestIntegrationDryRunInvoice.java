...
public class TestIntegrationDryRunInvoice extends TestIntegrationBase {
    ...
    public void testForIssue_1505() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(10));
        assertNotNull(account);
    ...
    public void testDryRunWithNoTargetDate() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(billingDay));
    ...
    public void testDryRunWithPendingSubscription() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(null));
