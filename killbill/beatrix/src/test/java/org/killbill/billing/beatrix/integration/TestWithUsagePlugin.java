...
public class TestWithUsagePlugin extends TestIntegrationBase {
    ...
    @Inject
    private PluginServiceRegistry<UsagePluginApi> pluginRegistry;
    ...
    public void beforeClass() throws Exception {
        ...
        pluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn("TestUsagePluginApi"), testUsagePluginApi);
    }
