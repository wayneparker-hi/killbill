...
public class TestHardenCatalogPlugin extends TestIntegrationBase {
    ...
    @Inject
    private PluginServiceRegistry<CatalogPluginApi> pluginRegistry;
    ...
    public void beforeClass() throws Exception {
        ...
        pluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn("TestHardenCatalogPlugin"), testCatalogPluginApi);
