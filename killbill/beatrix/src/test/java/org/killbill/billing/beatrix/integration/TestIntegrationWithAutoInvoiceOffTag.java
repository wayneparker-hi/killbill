...
public class TestIntegrationWithAutoInvoiceOffTag extends TestIntegrationBase {
    ...
    public void beforeMethod() throws Exception {
        ...
        super.beforeMethod();
        account = createAccountWithBuiltInPaymentMethod(getAccountData(25));
    ...
    public void testAutoInvoiceOffWithTZ() throws Exception {
        ...
        account = createAccountWithBuiltInPaymentMethod(getAccountData(null, DateTimeZone.forID("America/Los_Angeles")));
