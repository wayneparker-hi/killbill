...
public class TestWithInvoicePlugin extends TestIntegrationBase {
    ...
    @Inject
    private PluginServiceRegistry<InvoicePluginApi> pluginRegistry;
    ...
    public void beforeClass() throws Exception {
        ...
        pluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn("TestInvoicePluginApi"), testInvoicePluginApi);
    }
