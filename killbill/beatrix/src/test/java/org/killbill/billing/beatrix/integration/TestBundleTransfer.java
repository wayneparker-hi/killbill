...
public class TestBundleTransfer extends TestIntegrationBase {
    ...
    public void testBundleTransferWithBPAnnualOnly() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(3));
        ...
        // BUNDLE TRANSFER
        final Account newAccount = createAccountWithBuiltInPaymentMethod(getAccountData(17));
    ...
    public void testBundleTransferWithBPMonthlyOnly() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(0));
        ...
        // BUNDLE TRANSFER
        final Account newAccount = createAccountWithBuiltInPaymentMethod(getAccountData(0));
    ...
    public void testBundleTransferWithBPMonthlyOnlyWIthCancellationImm() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(9));
        ...
        // BUNDLE TRANSFER
        final Account newAccount = createAccountWithBuiltInPaymentMethod(getAccountData(15));
    ...
    public void testBundleTransferWithAddOn() throws Exception {
        ...
        final Account account = createAccountWithBuiltInPaymentMethod(getAccountData(1));
        final Account newAccount = createAccountWithBuiltInPaymentMethod(getAccountData(1));
