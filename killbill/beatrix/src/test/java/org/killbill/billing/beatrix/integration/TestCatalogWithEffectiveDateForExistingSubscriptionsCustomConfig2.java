...
public class TestCatalogWithEffectiveDateForExistingSubscriptionsCustomConfig2 extends TestIntegrationBase {
    ...
    public void testSubscriptionWithBothAccounts() throws Exception {
        ...
        final Account account1 = createAccountWithBuiltInPaymentMethod(getAccountData(28));
        Invoice curInvoice1;
        if (isAccount1) {
        ...
        final Account account2 = createAccountWithBuiltInPaymentMethod(getAccountData(6));
        Invoice curInvoice2;
        if (isAccount2) {
