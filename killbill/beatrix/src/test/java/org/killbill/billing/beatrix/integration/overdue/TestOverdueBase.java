...
public abstract class TestOverdueBase extends TestIntegrationBase {
    ...
    protected void setupAccount() throws Exception {
        account = createAccountWithBuiltInPaymentMethod(getAccountData(0));
        assertNotNull(account);

        paymentApi.addPaymentMethod(account, UUID.randomUUID().toString(), BeatrixIntegrationModule.BUILT_IN_PLUGIN_NAME, true, paymentMethodPlugin, PLUGIN_PROPERTIES, callContext);
    }
