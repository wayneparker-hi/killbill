...
public class DefaultCurrencyConversionApi implements CurrencyConversionApi {
    ...
    private final PluginServiceRegistry<CurrencyPluginApi> registry;

    @Inject
    public DefaultCurrencyConversionApi(final CurrencyConfig config, final PluginServiceRegistry<CurrencyPluginApi> registry) {
        this.config = config;
