...
public class DefaultCurrencyProviderPluginRegistry implements PluginServiceRegistry<CurrencyPluginApi> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final CurrencyPluginApi service) {
