...
public class DefaultCurrencyProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<CurrencyPluginApi>> {
    ...
    @Override
    public PluginServiceRegistry<CurrencyPluginApi> get() {
