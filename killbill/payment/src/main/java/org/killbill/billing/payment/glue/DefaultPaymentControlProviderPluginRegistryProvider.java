...
public class DefaultPaymentControlProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<PaymentControlPluginApi>> {
    ...
    @Override
    public PluginServiceRegistry<PaymentControlPluginApi> get() {
        ...
        final PluginServiceDescriptor desc = DefaultPluginServiceDescriptor.builtIn(DefaultPaymentControlProviderPlugin.PLUGIN_NAME);
        ...
        final PluginServiceDescriptor desc2 = DefaultPluginServiceDescriptor.builtIn(InvoicePaymentControlPluginApi.PLUGIN_NAME);
