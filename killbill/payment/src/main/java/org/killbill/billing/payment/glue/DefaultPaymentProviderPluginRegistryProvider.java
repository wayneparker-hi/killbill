...
public class DefaultPaymentProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<PaymentPluginApi>> {
    ...
    @Override
    public PluginServiceRegistry<PaymentPluginApi> get() {
        ...
        final PluginServiceDescriptor desc = DefaultPluginServiceDescriptor.builtIn(ExternalPaymentProviderPlugin.PLUGIN_NAME);
