...
public class PaymentPluginServiceRegistration {
    ...
    private final PluginServiceRegistry<PaymentPluginApi> pluginRegistry;

    @Inject
    public PaymentPluginServiceRegistration(final PaymentDao paymentDao, final PluginServiceRegistry<PaymentPluginApi> pluginRegistry) {
