...
public class DefaultPaymentProviderPluginRegistry implements PluginServiceRegistry<PaymentPluginApi> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final PaymentPluginApi service) {
