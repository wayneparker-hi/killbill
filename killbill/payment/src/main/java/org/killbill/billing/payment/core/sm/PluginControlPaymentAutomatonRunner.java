...
public class PluginControlPaymentAutomatonRunner extends PaymentAutomatonRunner {
    ...
    protected final PluginServiceRegistry<PaymentControlPluginApi> paymentControlPluginRegistry;
    ...
    public PluginControlPaymentAutomatonRunner(final PaymentDao paymentDao, final GlobalLocker locker, final PaymentPluginServiceRegistration paymentPluginServiceRegistration,
                                               final PluginServiceRegistry<PaymentControlPluginApi> paymentControlPluginRegistry, final Clock clock, final PaymentProcessor paymentProcessor, @Named(RETRYABLE_NAMED) final RetryServiceScheduler retryServiceScheduler,
