...
public class DefaultPaymentControlProviderPluginRegistry implements PluginServiceRegistry<PaymentControlPluginApi> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final PaymentControlPluginApi service) {
