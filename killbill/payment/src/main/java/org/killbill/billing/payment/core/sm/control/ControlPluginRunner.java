...
public class ControlPluginRunner {
    ...
    private final PluginServiceRegistry<PaymentControlPluginApi> paymentControlPluginRegistry;
    private final PaymentConfig paymentConfig;

    @Inject
    public ControlPluginRunner(final PluginServiceRegistry<PaymentControlPluginApi> paymentControlPluginRegistry,
