...
public class PaymentModule extends KillBillModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<PluginServiceRegistry<PaymentPluginApi>>() {}).toProvider(DefaultPaymentProviderPluginRegistryProvider.class).asEagerSingleton();
        bind(new TypeLiteral<PluginServiceRegistry<PaymentControlPluginApi>>() {}).toProvider(DefaultPaymentControlProviderPluginRegistryProvider.class).asEagerSingleton();
        ...
        Multibinder.newSetBinder(binder(), new TypeLiteral<PluginServiceRegistry<?>>() {})
                   .addBinding().to(new TypeLiteral<PluginServiceRegistry<PaymentPluginApi>>() {});
        Multibinder.newSetBinder(binder(), new TypeLiteral<PluginServiceRegistry<?>>() {})
                   .addBinding().to(new TypeLiteral<PluginServiceRegistry<PaymentControlPluginApi>>() {});
