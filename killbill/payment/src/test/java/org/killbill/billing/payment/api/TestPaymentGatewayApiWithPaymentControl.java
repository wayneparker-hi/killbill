...
public class TestPaymentGatewayApiWithPaymentControl extends PaymentTestSuiteNoDB {
    ...
    @Inject
    private PluginServiceRegistry<PaymentControlPluginApi> controlPluginRegistry;
    ...
    public void beforeMethod() throws Exception {
        ...
        controlPluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn(TestPaymentGatewayApiControlPlugin.PLUGIN_NAME), plugin);

        validationPlugin = new TestPaymentGatewayApiValidationPlugin();
        controlPluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn(TestPaymentGatewayApiValidationPlugin.VALIDATION_PLUGIN_NAME), validationPlugin);
