...
public class TestRetryablePayment extends PaymentTestSuiteNoDB {
    ...
    @Inject
    private PluginServiceRegistry<PaymentPluginApi> pluginRegistry;
    @Inject
    private PluginServiceRegistry<PaymentControlPluginApi> retryPluginRegistry;
    @Inject
    ...
    public void beforeClass() throws Exception {
        ...
        retryPluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn(MockPaymentControlProviderPlugin.PLUGIN_NAME), mockRetryProviderPlugin);
