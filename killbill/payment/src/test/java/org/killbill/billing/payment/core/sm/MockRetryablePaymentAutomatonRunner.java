...
public class MockRetryablePaymentAutomatonRunner extends PluginControlPaymentAutomatonRunner {
    ...
    @Inject
    public MockRetryablePaymentAutomatonRunner(final PaymentDao paymentDao, final GlobalLocker locker, final PaymentPluginServiceRegistration paymentPluginServiceRegistration, final PluginServiceRegistry<PaymentControlPluginApi> retryPluginRegistry, final Clock clock, final TagInternalApi tagApi, final PaymentProcessor paymentProcessor,
    ...
    public PluginServiceRegistry<PaymentControlPluginApi> getRetryPluginRegistry() {
