...
public class TestInvoicePluginDispatcher extends InvoiceTestSuiteNoDB {
    ...
    @Inject
    PluginServiceRegistry<InvoicePluginApi> pluginRegistry;
    ...
    private void registerPlugin(final String plugin) {
        pluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn(plugin), new DefaultNoOpInvoiceProviderPlugin());
    }
}