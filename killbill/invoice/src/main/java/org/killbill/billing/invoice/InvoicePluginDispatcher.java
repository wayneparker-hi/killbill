...
public class InvoicePluginDispatcher {
    ...
    private final PluginServiceRegistry<InvoicePluginApi> pluginRegistry;
    private final InvoiceConfig invoiceConfig;

    @Inject
    public InvoicePluginDispatcher(final PluginServiceRegistry<InvoicePluginApi> pluginRegistry,
