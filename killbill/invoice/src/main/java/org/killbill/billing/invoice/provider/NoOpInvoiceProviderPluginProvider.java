...
public class NoOpInvoiceProviderPluginProvider implements Provider<DefaultNoOpInvoiceProviderPlugin> {
    ...
    private PluginServiceRegistry<InvoicePluginApi> registry;
    ...
    @Inject
    public void setPaymentProviderPluginRegistry(final PluginServiceRegistry<InvoicePluginApi> registry) {
