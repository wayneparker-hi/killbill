...
public class DefaultInvoiceProviderPluginRegistry implements PluginServiceRegistry<InvoicePluginApi> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final InvoicePluginApi service) {
