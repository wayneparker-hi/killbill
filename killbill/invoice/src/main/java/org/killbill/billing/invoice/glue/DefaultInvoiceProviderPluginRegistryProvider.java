...
public class DefaultInvoiceProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<InvoicePluginApi>> {
    ...
    @Override
    public PluginServiceRegistry<InvoicePluginApi> get() {
