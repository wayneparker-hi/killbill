...
public class DefaultInvoiceFormatterFactoryProviderPluginRegistry implements PluginServiceRegistry<InvoiceFormatterFactory>  {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final InvoiceFormatterFactory service) {
