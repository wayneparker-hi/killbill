...
public class HtmlInvoiceGenerator {
    ...
    private final PluginServiceRegistry<InvoiceFormatterFactory> invoiceFormatterFactoryPluginRegistry;
    ...
    public HtmlInvoiceGenerator(final InvoiceFormatterFactory builtInInvoiceFormatterFactory,
                                final PluginServiceRegistry<InvoiceFormatterFactory> invoiceFormatterFactoryPluginRegistry,
