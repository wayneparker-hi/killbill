...
public class DefaultHealthcheckPluginRegistry implements PluginServiceRegistry<Healthcheck> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final Healthcheck healthcheck) {
