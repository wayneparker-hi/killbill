...
public class TestPayment extends TestJaxrsBase {
    ...
    @Inject
    protected PluginServiceRegistry<PaymentPluginApi> registry;
    @Inject
    ...
    public void beforeMethod() throws Exception {
        ...
        controlPluginRegistry.registerService(DefaultPluginServiceDescriptor.builtIn(MockPaymentControlProviderPlugin.PLUGIN_NAME), mockPaymentControlProviderPlugin);
    }
