...
/**
 * Integration tests for {@code PluginResource.PluginServletResponseWrapper}.
 *
...
public class TestPluginIssue2205 extends TestJaxrsBase {
    ...
    private static final String TEST_PLUGIN_NAME = "test-plugin-resource";
    ...
    private static final String REDIRECT_LOCATION = "/plugins/test-plugin-resource/elsewhere";
    ...
    /**
     * Registers a dedicated test Plugin plugin that exposes one path per
     ...
     */
    private void setupPluginPlugin() {
        ((PluginServletRouter) servletRouter).registerServiceFromPath(TEST_PLUGIN_NAME, new HttpServlet() {
            @Override
