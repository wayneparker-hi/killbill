...
public class CatalogModule extends KillBillModule {
    ...
    protected void installCatalogPluginApi() {
        bind(new TypeLiteral<PluginServiceRegistry<CatalogPluginApi>>() {}).toProvider(DefaultCatalogProviderPluginRegistryProvider.class).asEagerSingleton();
        ...
        Multibinder.newSetBinder(binder(), new TypeLiteral<PluginServiceRegistry<?>>() {})
                   .addBinding().to(new TypeLiteral<PluginServiceRegistry<CatalogPluginApi>>() {});
