...
public class DefaultCatalogCache implements CatalogCache {
    ...
    private final PluginServiceRegistry<CatalogPluginApi> pluginRegistry;
    ...
    @Inject
    public DefaultCatalogCache(final PluginServiceRegistry<CatalogPluginApi> pluginRegistry,
