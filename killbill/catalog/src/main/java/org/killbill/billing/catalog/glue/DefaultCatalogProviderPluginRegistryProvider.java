...
public class DefaultCatalogProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<CatalogPluginApi>> {
    ...
    @Override
    public PluginServiceRegistry<CatalogPluginApi> get() {
