...
public class DefaultCatalogProviderPluginRegistry implements PluginServiceRegistry<CatalogPluginApi> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final CatalogPluginApi service) {
