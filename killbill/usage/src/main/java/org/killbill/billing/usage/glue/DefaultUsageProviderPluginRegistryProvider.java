...
public class DefaultUsageProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<UsagePluginApi>> {

    @Override
    public PluginServiceRegistry<UsagePluginApi> get() {
