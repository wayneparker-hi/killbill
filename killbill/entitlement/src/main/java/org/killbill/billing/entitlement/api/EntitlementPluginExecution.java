...
public class EntitlementPluginExecution {
    ...
    private final PluginServiceRegistry<EntitlementPluginApi> pluginRegistry;
    ...
    @Inject
    public EntitlementPluginExecution(final EntitlementApi entitlementApi, final PluginServiceRegistry<EntitlementPluginApi> pluginRegistry) {
