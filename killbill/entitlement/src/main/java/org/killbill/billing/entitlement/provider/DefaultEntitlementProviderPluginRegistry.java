...
public class DefaultEntitlementProviderPluginRegistry implements PluginServiceRegistry<EntitlementPluginApi> {
    ...
    @Override
    public void registerService(final PluginServiceDescriptor desc, final EntitlementPluginApi service) {
