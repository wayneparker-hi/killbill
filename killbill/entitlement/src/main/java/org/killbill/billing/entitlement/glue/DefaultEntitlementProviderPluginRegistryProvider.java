...
public class DefaultEntitlementProviderPluginRegistryProvider implements Provider<PluginServiceRegistry<EntitlementPluginApi>> {
    ...
    @Override
    public PluginServiceRegistry<EntitlementPluginApi> get() {
