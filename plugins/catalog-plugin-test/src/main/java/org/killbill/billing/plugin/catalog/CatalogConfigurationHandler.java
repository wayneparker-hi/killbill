...
public class CatalogConfigurationHandler extends YAMLPluginTenantConfigurationHandler<CatalogYAMLConfiguration, CatalogConfiguration> {
    ...
    public CatalogConfigurationHandler(final String region, final String pluginName, final KillbillApi killbillApi) {
        super(pluginName, killbillApi);
        this.region = region;
    }

    public CatalogConfigurationHandler(final String region, final String pluginName, final KillbillApi killbillApi, final String configurationKey) {
        super(pluginName, killbillApi, configurationKey);
        this.region = region;
    }
    ...
    static CatalogConfiguration fromYAML(final String raw) {
        final CatalogConfigurationHandler tmp = new CatalogConfigurationHandler("", CatalogTestPlugin.PLUGIN_NAME, null);
