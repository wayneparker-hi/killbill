...
public class GoCardlessCheckoutServlet {
    ...
    @Inject
    public GoCardlessCheckoutServlet(final Clock clock,
    ...
    public Result createSession(@Named("kbAccountId") final UUID kbAccountId,
        ...
        final CallContext context = new PluginCallContext(GoCardlessPlugin.PLUGIN_NAME, clock.getUTCNow(), kbAccountId, tenant.getId());
