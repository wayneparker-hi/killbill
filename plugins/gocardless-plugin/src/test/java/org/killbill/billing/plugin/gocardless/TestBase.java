...
public class TestBase {
    ...
    public void setUp() throws Exception {
        ...
        TestUtils.buildPaymentMethod(account.getId(), account.getPaymentMethodId(), GoCardlessPlugin.PLUGIN_NAME, killbillApi);

        goCardlessconfigurationHandler = new GoCardlessConfigurationHandler("", GoCardlessPlugin.PLUGIN_NAME, killbillApi);

        goCardlessPaymentpluginApi = new GoCardlessPaymentPluginApi(goCardlessconfigurationHandler,
                                                            killbillApi,
                                                            clock);

        TestUtils.updateKillbillApi(killbillApi, goCardlessPaymentpluginApi);
