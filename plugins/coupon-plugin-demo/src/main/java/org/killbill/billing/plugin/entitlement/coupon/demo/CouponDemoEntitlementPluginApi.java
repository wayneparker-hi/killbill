...
public class CouponDemoEntitlementPluginApi implements EntitlementPluginApi {
    ...
    private static final String COUPON_PROPERTY = CouponPlugin.PLUGIN_NAME + ":coupon";

    final Clock clock;
    final KillbillApi   killbillApi;

    public CouponDemoEntitlementPluginApi(final Clock clock,
                                          final KillbillApi killbillApi) {
        this.clock = clock;
