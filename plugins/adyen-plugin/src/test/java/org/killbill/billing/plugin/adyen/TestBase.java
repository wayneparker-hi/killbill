...
import org.killbill.billing.plugin.adyen.core.AdyenPlugin;
...
public class TestBase {
  ...
  public void setUp() throws Exception {
    ...
    TestUtils.buildPaymentMethod(
        account.getId(), account.getPaymentMethodId(), AdyenPlugin.PLUGIN_NAME, killbillApi);

    adyenConfigPropertiesConfigurationHandler =
        new AdyenConfigurationHandler(null, AdyenPlugin.PLUGIN_NAME, killbillApi);

    final PluginConfigProperties configPropertiesService =
        Mockito.mock(PluginConfigProperties.class);
    ...
    TestUtils.updateKillbillApi(killbillApi, adyenPaymentPluginApi);
