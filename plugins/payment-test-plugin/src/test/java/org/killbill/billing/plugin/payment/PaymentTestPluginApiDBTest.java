...
import static org.killbill.billing.plugin.payment.PaymentTestPlugin.PLUGIN_NAME;

public class PaymentTestPluginApiDBTest {

    @Mock
    KillbillApi             killbillApi;
    @Mock
    PluginConfigProperties configProperties;
    @Mock
    org.slf4j.Logger      logService;
    @Mock
    Clock                       clock;
    ...
    void beforeMethod() throws Exception {
        ...
        this.testingStates = new TestingStates();
        this.paymentTestPugin = new PaymentTestPluginApi(killbillApi,
