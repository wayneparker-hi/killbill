...
public abstract class BaseResource {
    ...
    protected CallContext createCallContext(final Optional<String> createdBy,
                                            ...
                                            final Tenant tenant) {
        final DateTime utcNow = osgiKillbillClock.getUTCNow();
        return new PluginCallContext(UUID.randomUUID(),
                                     createdBy.orElse(AnalyticsPlugin.PLUGIN_NAME),
                                     CallOrigin.EXTERNAL,
                                     UserType.SYSTEM,
                                     reason.orElse(null),
                                     comment.orElse(null),
