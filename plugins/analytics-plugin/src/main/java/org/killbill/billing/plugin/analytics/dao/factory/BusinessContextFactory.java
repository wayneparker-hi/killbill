...
public class BusinessContextFactory extends BusinessFactoryBase {
    ...
    public BusinessContextFactory(final UUID accountId,
        ...
        super(accountId, callContext, currencyConversionDao, killbillApi, osgiConfigPropertiesService, clock, analyticsConfigurationHandler);
        ...
        this.safeAccountAuditLogs = new SafeAccountAuditLogs(killbillApi, accountId, callContext);
