...
public class BusinessExecutor {
    ...
    public static ExecutorService newCachedThreadPool(final PluginConfigProperties osgiConfigPropertiesService) {
    ...
    @VisibleForTesting
    static int getNbThreads(PluginConfigProperties osgiConfigPropertiesService) {
