...
public class ReportsUserApi {
    ...
    public ReportsUserApi(final KillbillApi killbillApi,
        ...
        queryEngine = new QueryEngine(BusinessDBIProvider.get(osgiKillbillDataSource, metricRegistry));
