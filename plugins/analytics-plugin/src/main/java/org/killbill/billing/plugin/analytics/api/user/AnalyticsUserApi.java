...
public class AnalyticsUserApi {
    ...
    public AnalyticsUserApi(final KillbillApi killbillApi,
        ...
        this.analyticsDao = new AnalyticsDao(killbillApi, osgiKillbillDataSource, metricRegistry);
    ...
    public void rebuildAnalyticsForAccount(final UUID accountId, final CallContext context) throws AnalyticsRefreshException {
        final BusinessContextFactory businessContextFactory = new BusinessContextFactory(accountId, context, currencyConversionDao, killbillApi, osgiConfigPropertiesService, clock, analyticsConfigurationHandler);
    ...
    public RefreshResult rebuildAnalyticsForAllAccounts(final CallContext context) {
        ...
        Pagination<Account> accounts = killbillApi.getAccountUserApi().getAccounts(0L, 100L, context);
        ...
        while (nextOffSet != null) {
            accounts = killbillApi.getAccountUserApi().getAccounts(nextOffSet, 100L, context);
