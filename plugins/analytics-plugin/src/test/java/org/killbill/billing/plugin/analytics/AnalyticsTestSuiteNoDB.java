...
public abstract class AnalyticsTestSuiteNoDB {
    ...
    protected DataSource killbillDataSource;
    protected MetricRegistry metricRegistry;
    protected PluginConfigProperties osgiConfigPropertiesService;
    ...
    public void setUp() throws Exception {
        ...
        killbillApi = Mockito.mock(KillbillApi.class);
        ...
        killbillDataSource = Mockito.mock(DataSource.class);
        final DataSource dataSource = Mockito.mock(DataSource.class);
        killbillDataSource = dataSource;
        ...
        osgiConfigPropertiesService = Mockito.mock(PluginConfigProperties.class);
        ...
        analyticsConfigurationHandler = new AnalyticsConfigurationHandler(null, AnalyticsPlugin.PLUGIN_NAME, killbillApi);
