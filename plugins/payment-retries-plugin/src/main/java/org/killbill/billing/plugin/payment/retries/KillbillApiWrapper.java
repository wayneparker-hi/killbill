...
public class KillbillApiWrapper {

    private static final Logger logger = LoggerFactory.getLogger(KillbillApiWrapper.class);

    private final KillbillApi killbillApi;

    public KillbillApiWrapper(final KillbillApi killbillApi) {
