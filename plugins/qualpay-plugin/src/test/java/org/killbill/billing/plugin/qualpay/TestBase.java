...
public class TestBase {
    ...
    public void setUp() throws Exception {
        ...
        TestUtils.buildPaymentMethod(account.getId(), account.getPaymentMethodId(), QualpayPlugin.PLUGIN_NAME, killbillApi);

        qualpayConfigPropertiesConfigurationHandler = new QualpayConfigPropertiesConfigurationHandler(QualpayPlugin.PLUGIN_NAME, killbillApi, null);
        setDefaultConfigurable();

        final PluginConfigProperties configPropertiesService = Mockito.mock(PluginConfigProperties.class);
        ...
        TestUtils.updateKillbillApi(killbillApi, qualpayPaymentPluginApi);
