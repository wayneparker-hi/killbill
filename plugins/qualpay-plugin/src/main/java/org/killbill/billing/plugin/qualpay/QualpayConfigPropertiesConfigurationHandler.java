...
public class QualpayConfigPropertiesConfigurationHandler extends PluginTenantConfigurableConfigurationHandler<QualpayConfigProperties> {
    ...
    public QualpayConfigPropertiesConfigurationHandler(final String pluginName, final KillbillApi killbillApi, final String region) {
        // -plugin required for Kaui?
        super(pluginName + "-plugin", killbillApi);
        this.region = region;
    }
