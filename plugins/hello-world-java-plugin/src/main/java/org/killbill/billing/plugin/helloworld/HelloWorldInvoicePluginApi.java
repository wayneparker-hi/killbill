...
class HelloWorldInvoicePluginApi extends PluginInvoicePluginApi implements NotificationPluginApi {

    public HelloWorldInvoicePluginApi(final KillbillApi killbillApi, final PluginConfigProperties configProperties,
                                      final Clock clock) {
