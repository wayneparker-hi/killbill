...
public class EmailNotificationConfiguration {
    ...
    private static final String SMTP_PROPERTY_PREFIX = EmailNotificationPlugin.PROPERTY_PREFIX + "smtp.";
    private static final String CREDENTIALS_PROPERTY_PREFIX = EmailNotificationPlugin.PROPERTY_PREFIX + "credentials.";
    ...
    {
        String defaultEvents = properties.getProperty(EmailNotificationPlugin.PROPERTY_PREFIX + "defaultEvents");
