...
public class EmailNotificationServlet {
    ...
    @Inject
    public EmailNotificationServlet(final ConfigurationDao dao, final Clock clock) {
        this.clock = clock;
        this.dao = dao;
    }
    ...
    public Result doUpdateEventTypePerAccount(@Named("kbAccountId") final UUID kbAccountId,
        ...
        return EmailNotificationService.doUpdateEventTypePerAccount(this.dao, kbAccountId, kbTenantId, eventTypes, clock.getUTCNow());
    }
}
