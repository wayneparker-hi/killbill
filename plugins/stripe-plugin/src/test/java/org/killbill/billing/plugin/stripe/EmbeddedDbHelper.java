...
public class EmbeddedDbHelper {
    ...
    private static final org.slf4j.Logger LOGGER =
            org.slf4j.LoggerFactory.getLogger(EmbeddedDbHelper.class);
    ...
    public void startDb() throws Exception {
        ...
        try {
            ...
            // The engine-specific DDL creates shared objects -- a "datetime" domain on PostgreSQL,
            // for instance. Against a throwaway embedded database it always succeeds; against a
            // long-lived local database shared with other modules it fails the second time, which
            // is not a problem: the object it wanted is already there.
            LOGGER.info("Engine-specific DDL was already applied to this database: {}", e.getMessage());
        }
