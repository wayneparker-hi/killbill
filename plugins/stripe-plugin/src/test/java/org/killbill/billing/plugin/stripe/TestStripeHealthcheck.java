...
public class TestStripeHealthcheck extends TestBase {
    ...
    public void testHealthcheckNoTenant() {
        final StripeConfigPropertiesConfigurationHandler noConfigHandler = new StripeConfigPropertiesConfigurationHandler(StripePlugin.PLUGIN_NAME, killbillApi, null);
