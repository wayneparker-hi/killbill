...
public class TestBase {
    ...
    public void setUp() throws Exception {
        ...
        TestUtils.buildPaymentMethod(account.getId(), account.getPaymentMethodId(), StripePlugin.PLUGIN_NAME, killbillApi);

        stripeConfigPropertiesConfigurationHandler = new StripeConfigPropertiesConfigurationHandler(StripePlugin.PLUGIN_NAME, killbillApi, null);
        ...
        TestUtils.updateKillbillApi(killbillApi, stripePaymentPluginApi);
