...
public class StripeCheckoutServlet extends PluginHealthcheck {
    ...
    @Inject
    public StripeCheckoutServlet(final Clock clock,
    ...
    public Result createSession(@Named("kbAccountId") final UUID kbAccountId,
        ...
        final CallContext context = new PluginCallContext(StripePlugin.PLUGIN_NAME, clock.getUTCNow(), kbAccountId, tenant.getId());
