...
public class TestAvaTaxInvoicePluginApi extends AvaTaxRemoteTestBase {
    ...
    public void setUp() throws Exception {
        ...
        callContext = new PluginCallContext(AvaTaxPlugin.PLUGIN_NAME, clock.getUTCNow(), account.getId(), UUID.randomUUID());
        ...
        final AvaTaxConfigurationHandler avaTaxConfigurationHandler = new AvaTaxConfigurationHandler(AvaTaxPlugin.PLUGIN_NAME,
                                                                                                     killbillApi);
    ...
    public void testRepair() throws Exception {
        ...
        Mockito.when(killbillApi.getInvoiceUserApi().getInvoiceByInvoiceItem(Mockito.eq(taxableItem1.getId()), Mockito.<TenantContext>any()))
               .thenReturn(invoice1);
