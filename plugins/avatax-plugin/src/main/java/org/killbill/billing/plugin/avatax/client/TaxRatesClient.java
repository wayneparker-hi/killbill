...
public class TaxRatesClient extends HttpClient {
    ...
    public TaxRatesClient(final Properties properties) throws GeneralSecurityException {
        super(properties.getProperty(AvaTaxPlugin.TAX_RATES_API_PROPERTY_PREFIX + "url"),
              properties.getProperty(AvaTaxPlugin.TAX_RATES_API_PROPERTY_PREFIX + "accountId"),
              properties.getProperty(AvaTaxPlugin.TAX_RATES_API_PROPERTY_PREFIX + "licenseKey"),
