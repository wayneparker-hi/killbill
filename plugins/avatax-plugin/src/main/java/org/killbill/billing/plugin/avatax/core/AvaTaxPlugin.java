 ...
 */
public class AvaTaxPlugin extends PluginBase {

    private static final Logger logger = LoggerFactory.getLogger(AvaTaxPlugin.class);
    ...
    protected void startPlugin() throws Exception {
        ...
        final AvaTaxDao dao = new AvaTaxDao(dataSource());
        ...
        final InvoicePluginApi invoicePluginApi = new AvalaraInvoicePluginApi(avaTaxConfigurationHandler,
                                                                              ...
                                                                              configProperties,
                                                                              clock);
        registerService(InvoicePluginApi.class, invoicePluginApi);
        ...
        final Healthcheck avalaraHealthcheck = new AvalaraHealthcheck(avaTaxConfigurationHandler,
                                                                      taxRatesConfigurationHandler);
        registerService(Healthcheck.class, avalaraHealthcheck);
        ...
        registerService(Servlet.class, servlet);
    ...
    private void runMigrationsIfEnabled() {
        if (Boolean.parseBoolean(configProperties.getProperties().getProperty(SHOULD_RUN_MIGRATIONS_PROPERTY, "true"))) {
            DBEngine dbEngine;
            try {
                dbEngine = PluginDao.getDBEngine(dataSource());
