...
public class AvaTaxClient extends HttpClient {
    ...
    public AvaTaxClient(final Properties properties) throws GeneralSecurityException {
        super(properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "url"),
              properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "accountId"),
              properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "licenseKey"),
              properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "proxyHost"),
        ...
        this.configured = properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "url") != null && properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "accountId") != null && properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "licenseKey") != null;
        this.companyCode = properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "companyCode", "DEFAULT");
        this.sanitizedCompanyCode = sanitizeCompanyCode(this.companyCode);
        this.commitDocuments = Boolean.parseBoolean(properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "commitDocuments"));
        this.skipAnomalousAdjustments = Boolean.parseBoolean(properties.getProperty(AvaTaxPlugin.PROPERTY_PREFIX + "adjustments.lenientMode"));
    }
