...
public class VertexTaxCalculatorITest extends VertexRemoteTestBase {
    ...
    public void setUp() throws Exception {
        ...
        calculator = new VertexTaxCalculator(vertexApiConfigurationHandler, dao, clock, killbillApi);
    ...
    private void testComputeItemsOverTime(final Account account) throws Exception {
        ...
        Mockito.when(killbillApi.getInvoiceUserApi().getInvoiceByInvoiceItem(Mockito.eq(taxableItem2.getId()), Mockito.any()))
               .thenReturn(invoice);
