...
public class TestBase {
    ...
    protected PluginConfigProperties configPropertiesService;
    ...
    public void setUp() throws Exception {
        ...
        configPropertiesService = new PluginConfigProperties(Mockito.mock(PluginContext.class));
    }
    ...
    public void setUpDB() throws Exception {
        ...
        TestUtils.updateKillbillApi(killbillApi, depositPaymentPluginApi);
    }
